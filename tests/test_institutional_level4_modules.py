...
from reco_trading.core.market_data import MarketQuality, validate_market_quality_contract
...
def test_market_quality_contract_validation_rejects_missing_avg_volume() -> None:
    ...
    try:
        validate_market_quality_contract(BrokenMarketQuality())
...
def test_market_quality_contract_validation_accepts_real_dataclass() -> None:
    quality = MarketQuality(True, 'ok', 1.0, 0.01, 10.0, 0.0)
    validate_market_quality_contract(quality)
